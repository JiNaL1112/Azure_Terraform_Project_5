...
location                = "centralindia"       # Azure region for resource deployment
...
gitops_repo_url  = "https://github.com/JiNaL1112/Azure_Terraform_Project_5.git" # GitOps repository for infrastructure configs (reference only)
argocd_namespace = "argocd"                                          # Namespace where ArgoCD will be deployed

# Application Deployment Configuration 
app_repo_url  = "https://github.com/JiNaL1112/Azure_Terraform_Project_5.git" # Repository containing your application manifests
